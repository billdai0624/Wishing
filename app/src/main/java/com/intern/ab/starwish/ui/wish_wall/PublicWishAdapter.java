package com.intern.ab.starwish.ui.wish_wall;
...
import com.intern.ab.starwish.model.PublicWish_item;
...
public class PublicWishAdapter extends ArrayAdapter<PublicWish_item> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        /*if (holder.wishTv.getText().toString().length() <= 40) {
            holder.publicWishItem_LL.setMinimumHeight((int) (getContext().getsources().getDimension(itemSize[0])));
